...
Diperbarui: 2026-09-20T18:57:42+07:00
...
| P0.5 — Contoh belajar siap diperiksa | **Siap diuji internal** | Prototype 20 state, seed draft U01-L1, serta 26 draft audio asset dengan checksum dari VOICEVOX Nemo Engine 0.24.0 siap diuji tim internal. | Uji internal lebih dulu lalu kumpulkan evidence dan approval eksternal. |

## Hal yang masih menunggu

- **P0.5:** Audio binary hanya local-only dan tidak dilacak Git; receipt terms/rights exact hash, audio QA, dan review akademik belum selesai.
