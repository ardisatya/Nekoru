...
Diperbarui: 2026-09-20T14:46:44+07:00
...
| P0.3 — Kerangka aplikasi dapat dijalankan | **Siap diuji internal** | Monorepo dan pemeriksaan secret/dependency lulus; migration serta integration test berjalan pada PostgreSQL 18.6 lokal yang sementara. | Tetapkan Git author, buat commit awal, push ke origin/main, lalu periksa hasil hosted CI. |
| P0.4 — Aturan data dapat diuji otomatis | **Menunggu pemeriksaan** | Aturan schema, version, hash, event, API, dan content tervalidasi; migration kosong, constraint idempotency, dan rollback transaksi lulus pada PostgreSQL 18.6 lokal. | Reviewer data/teknis memeriksa migration dan contract; hosted CI tetap perlu dijalankan setelah commit dikirim. |
...
- **P0.3:** Hosted CI belum berjalan; remote sudah terhubung tetapi repository tujuan belum memiliki branch/commit.
