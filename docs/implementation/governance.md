...
| -------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------- |
| Seed/audio/rights/approval U01-L1 belum lengkap                      | Phase 0 `done` dan Phase 1 runtime | Audio binary local-only; seed tetap `draft` dan runtime selection menolak |
