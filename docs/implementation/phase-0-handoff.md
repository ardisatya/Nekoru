...
| Academic review receipt           | `docs/implementation/u01-l1-academic-review.json`                    | Receipt `REVIEW.CONTENT.U01.L1.ACADEMIC.000001`, status `approved`; external Academic Lead approval dilaporkan owner, exact reviewer receipt belum dilampirkan                                     |
| Linguistic review receipt         | `docs/implementation/u01-l1-linguistic-review.json`                  | Receipt `REVIEW.CONTENT.U01.L1.LINGUISTIC.000001`, status `approved`; external Japanese Linguistic Reviewer approval dilaporkan owner, exact reviewer receipt belum dilampirkan                    |
| Content review decision           | `docs/implementation/u01-l1-content-review-local-only-decision.json` | Status `approved`; external approval reported-by-owner; seed tetap draft dan runtime disabled                                                                                                      |
...
- Academic/Linguistic receipt berstatus `approved` berdasarkan external approval yang dilaporkan owner. Identitas/timestamp/receipt exact belum dilampirkan; publication/runtime tetap tidak dibuka.
- Formal AT reviewer evidence, usability research, dan physical-device playback evidence tetap tidak diklaim untuk public/production scope; exception local-only tidak mengubah gate tersebut.
